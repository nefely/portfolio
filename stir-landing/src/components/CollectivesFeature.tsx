  ...
  return (
    <section className="bg-ink-soft py-16 lg:py-24">
      <div className="mx-auto w-full max-w-[1199px] px-6 lg:px-0">
        ...
        <div className="mt-14 overflow-hidden rounded-2xl shadow-[0_0_240px_rgba(25,25,25,0.7)]">
          <img src={collectivesMockup} alt="Stir Collectives dashboard" className="w-full" />
        </div>
      </div>
    </section>
  )
